...
Design ref: docs/specs/fundus_only_ceiling_design.md §4 P1. The existing --disc-crop adds the
...
CV = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "results", "cv_long")
