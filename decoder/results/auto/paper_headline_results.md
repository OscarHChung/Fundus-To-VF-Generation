...
`m1sev` → `p1disc` → `p1disc_denoise`. Two earlier documents (`decoder/specs/fundus_only_ceiling_design.md`
§3.1 and `docs/superpowers/specs/2026-07-11-sub4-fundus-only-vf-design.md`) still quote `m1sev`'s
