...
Run: python -m pytest decoder/tests_external_eval.py -q   (pure JSON/glob checks -- no torch)
"""
import glob
import json
import os
...
CV_LONG_DIR = os.path.join(os.path.dirname(__file__), "results", "cv_long")
REPORT_JSON = os.path.join(os.path.dirname(__file__), "results", "auto", "papila_external_eval.json")
