...
decoder/tests_session3.py::test_denoised_target_swap, which already proves the generic
...
Run:  python -m pytest decoder/tests_denoise_target.py -q
  or: python decoder/tests_denoise_target.py
"""
