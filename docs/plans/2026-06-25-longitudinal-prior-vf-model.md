...
**Files:** Modify `build_longitudinal_grape.py`; regenerate `data/vf_tests/grape_longitudinal.json`; re-run `decoder/diagnostics.py split-long`. Test in `decoder/tests/test_session3.py`.
...
**Files:** Create `decoder/longitudinal_dataset.py`. Test in `decoder/tests/test_session3.py`.
...
**Files:** Create `decoder/longitudinal_model.py` (subclass `PerPointVFModel`). Test in `decoder/tests/test_session3.py`.
