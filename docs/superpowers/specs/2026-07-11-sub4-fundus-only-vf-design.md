...
- **Head-to-head, stated honestly (the reliable win):** the robust claim is the **composition-adjusted** one —
  ...
  value 4.686 (not a range). See `paper_headline_results.md` §1.3 for the current numbers, including the
