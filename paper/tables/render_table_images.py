...
Usage:  python paper/tables/render_table_images.py
...
render(
    ...
    "Table 1 — Sectoral MAE (canonical Garway-Heath 6-sector map)",
    ["Garway-Heath sector", "MAE (dB)", "n points"],
    [["Temporal (papillomacular)", "3.79", "3,786"], ["Nasal (temporal-wedge field)", "3.79", "2,524"],
     ["Superonasal", "3.92", "6,941"], ["Superotemporal", "3.99", "6,310"],
     ["Inferonasal", "4.35", "4,417"], ["Inferotemporal", "4.43", "8,834"]],
    col_widths=[3.6, 1.2, 1.2], wrap_widths=[0, 0, 0],
    legend="Legend. Pooled per-location MAE within each canonical Garway-Heath disc sector\n"
           "(6-sector map, Garway-Heath 2000; out-of-fold leak-free 5-fold CV; pooled 4.10 dB).\n"
           "Lowest in the temporal (papillomacular) and nasal (temporal-wedge) sectors, highest in\n"
           "the inferotemporal and inferonasal sectors — the inferior-disc sectors serving the\n"
           "superior field, where glaucomatous arcuate defects concentrate.",
)
